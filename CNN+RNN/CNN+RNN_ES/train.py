...
def train_cnn_rnn():
	...
	x, y, vocabulary, vocabulary_inv, df, labels = data_helper.load_data(input_file)
	...
	x_train, x_dev, y_train, y_dev = train_test_split(x, y, test_size=0.1557971014)
	...
	with graph.as_default():
		...
		with sess.as_default():
			...
			logging.critical('Training is complete')
	...
	#os.rename(path + '.ckpt', trained_dir + 'best_model.ckpt')
